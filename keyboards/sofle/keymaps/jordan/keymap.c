...
void draw_icon(int offset_y, bool is_filled, enum icons icon) {
    for (int y = 0; y<14; y++) {
        for (int x = 0; x<14; x++) {
            bool top_on;
            bool bottom_on;
...
static void print_status_narrow(void) {
    ...
    switch (get_highest_layer(layer_state)) {
        case _COLEMAK:
        case _QWERTY:
            draw_icon(80, false, BASE);
            break;
        case _RAISE:
            draw_icon(80, true, UPPER);
            break;
        case _LOWER:
            draw_icon(80, true, LOWER);
            break;
        case _ADJUST:
            draw_icon(80, true, ADJUST);
            break;
        default:
            draw_icon(80, false, BASE);
    }
...
static void print_right_narrow(void) {
    // switch (get_highest_layer(layer_state)) {
    //     case _COLEMAK:
    //     case _QWERTY:
    //         draw_icon(48, false, BASE);
    //         break;
    //     case _RAISE:
    //         draw_icon(48, true, UPPER);
    //         break;
    //     case _LOWER:
    //         draw_icon(48, true, LOWER);
    //         break;
    //     case _ADJUST:
    //         draw_icon(48, true, ADJUST);
    //         break;
    //     default:
    //         draw_icon(48, false, BASE);
    // }
